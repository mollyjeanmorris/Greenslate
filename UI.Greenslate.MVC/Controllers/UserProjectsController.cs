...
namespace UI.Greenslate.MVC.Controllers
{
    public class UserProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,ProjectId,IsActive,AssignedDate")] UserProject userProject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,ProjectId,IsActive,AssignedDate")] UserProject userProject)
        {
            if (ModelState.IsValid)
            {
